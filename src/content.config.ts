...
const officersCollection = defineCollection({
  ...
  schema: z.object({
    ...
    tier: z.enum(['institutional', 'secretariat', 'committee']).default('secretariat'),
    roleTitle: z.string().optional(),
    affiliation: z.string().optional(),
    committee: z.string().optional(),
    program: z.string().optional().default('College of Arts and Sciences'),
...
const hallOfFameCollection = defineCollection({
  ...
  schema: z.object({
    ...
    gwa: z.number().min(1.00).max(5.00).optional(),
    category: z.enum(["Dean's Lister", 'Topnotcher', 'First Honors', 'Second Honors']),
