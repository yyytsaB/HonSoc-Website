...
- Produces an **Implementation Review** document (see format below)
- Produces a **Walkthrough** document (see format below)
- Updates `ROADMAP.md` to mark completed items (see §7d below)
...
4. **Self-assessed §5 DoD checklist** — each item marked ✅ or ❌ with a
   one-line note
5. **Implementation Review** — structured doc (§7b format)
6. **Walkthrough** — narrative doc (§7c format)

Claude will not start a review until all six sections are present.

### §7b · Implementation Review Format

Gemini writes `implementation-review-MN.md` (N = milestone number) in `.agent/reviews/`.

```
## Milestone N — Implementation Review

### Scope
What the milestone covered; what was explicitly out of scope.
...
### Risk & Debt Log
- [file:line] — [concern] — [mitigation or deferred]

### §5 DoD Self-Assessment
- ✅ / ❌  [item] — [one-line note]
```

### §7c · Walkthrough Format
